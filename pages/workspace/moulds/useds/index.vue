<template>
  <view class="maintains">
    <view class="headersty">
      <u-navbar :title-color="'#323232'" :back-icon-color="'#323232'" :back-text="'返回'" :back-icon-name="'arrow-leftward'" :back-icon-size="34" :is-fixed="true" :is-back="true" :background="{background: '#fff'}" title="模具使用">
    ...
    <view>
      ...
      <view class="bodys">
        ...
        <usedsList v-if="active === 1" />
        <usedsListready v-if="active === 2" />
      </view>
    </view>
...
import usedsList from './usedsList'
import usedsListready from './usedsListready'
