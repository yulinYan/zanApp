      ...
      <view v-for="(item, index) of list" :key="index" class="listy" @click="clickGet(item)">
        <u-row>
          ...
          <u-col class="u-padding-top-26 u-padding-bottom-26 u-padding-left-26" span="7" @click="clickGet(item)">
            ...
            <view class="itemstys">
              创建时间：
              <view class="valuesty u-line-1" style="width: 235rpx;line-height: 21rpx;">{{ item.createTime && item.createTime.length> 10 ? item.createTime.substring(0,10):item.createTime }}</view>
            </view>
          </u-col>
        </u-row>
        <div class="subscript">
