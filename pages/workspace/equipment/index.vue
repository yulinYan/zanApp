      ...
      gridList: [
        {
          ...
          url: '/pages/workspace/equipment/repair/index',
          power: '/devRepair/programmeImplement',
          name: '设备维修'
        },
        // {
        ...
        // },
        {
          ...
          url: '/pages/workspace/equipment/maintain/index',
          power: '/devMaintain/maintainPlanImplement',
          name: '设备保养'
        }
      ]
    }
