      ...
      <view v-for="(item, index) of list" :key="index" class="listy" @click="clickGet(item)">
        <u-row class="listRow">
          <view class="leftsty" @click="clickGet(item)">
            ...
            <view class="u-font-23 u-text-center u-margin-bottom-26 u-line-1 fontsty">{{ item.code }}</view>
          </view>
          <view class="centersty" @click="clickGet(item)">
            ...
            <view class="itemsty" @click="clickGet(item)">
              <view class="valueKey">设备编号:</view>
          ...
          <view class=" rightsty" @click="clickGet(item)">
            ...
            <view class="itemsty">
              <view class="valueKey">任务阶段:</view>
              <view class="valuesty" v-if="item.repairProjectStatus === 0 && item.repairTaskExeStatus===0">方案制定</view>
              <view class="valuesty" v-if="item.repairProjectStatus === 1 && item.repairTaskExeStatus===0">维修作业</view>
            </view>
            <view class="itemsty">
