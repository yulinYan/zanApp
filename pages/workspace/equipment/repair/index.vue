<template>
  <view class="maintains">
    <view class="headersty">
      <u-navbar :title-color="'#323232'" :back-icon-color="'#323232'" :back-text="'返回'" :back-icon-name="'arrow-leftward'" :back-icon-size="34" :is-fixed="true" :is-back="true" :background="{background: '#fff'}" title="设备维修">
    ...
    <view>
      <view class="u-flex tabbs u-padding-left-65 u-padding-right-65 u-padding-top-25">
        <u-button :class="active === 0 ? 'actives' : ''" :hair-line="false" class="custom-style" @click="tabbs(0)">设备维修</u-button>
...
export default {
  ...
  onLoad() {
    var self = this
    uni.$on('showRepairInfo', function (data) {
