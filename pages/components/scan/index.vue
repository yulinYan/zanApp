...
export default {
  data() {
    return {
      name: '请将条码或二维码对准扫码框！', //要在扫码界面自定义的内容
      flash: false, //是否打开摄像头
      type: ''
    }
  },
  onLoad(d) {
    this.type = uni.getStorageSync('scan_type')
    uni.removeStorageSync('scan_type')
  ...
  methods: {
    ...
    createBarcode(currentWebview) {
      var filters = [plus.barcode.QR, plus.barcode.EAN13, plus.barcode.EAN8]
      barcode = plus.barcode.create('barcode', filters, {
        top: '0',
        left: '0',
        width: '100%',
        height: '100%',
